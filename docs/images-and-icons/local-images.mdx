...
There are two ways to add images to your app - you can wither include them in your app bundle, or load them via a url. Local images are included in the app bundle.
