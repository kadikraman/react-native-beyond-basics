...
There are two ways to animate your UI in React Native: you can either define whe exact animation yourself, or you can let [LayoutAnimation](https://reactnative.dev/docs/layoutanimation) do all the work for you.
