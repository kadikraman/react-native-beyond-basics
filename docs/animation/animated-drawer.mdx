...
[**Add an animated drawer** 23406fd6b01ada4aa245ce2ad7f382d538f6c12f](https://github.com/kadikraman/mood-tracker/commit/23406fd6b01ada4aa245ce2ad7f382d538f6c12f)

<img
  src={useBaseUrl('/img/animated-drawer/ios.png')}
  alt="iOS animated drawer"
  width="50%"
/>
<img
  src={useBaseUrl('/img/animated-drawer/android.png')}
  alt="Android animated drawer"
  width="50%"
/>
