...
In the interest of speed, I've already created the icon set for us to use. You can download it [here](https://kadikraman.github.io/react-native-beyond-basics/img/AppIcon.appiconset.zip).
