...
<img src={useBaseUrl("/img/images/ios-local-image.png")} alt="iOS local image" width="50%" />
<img src={useBaseUrl("/img/images/android-local-image.png")} alt="Android local image" width="50%" />

## Images from url

In order to render images from a url, let's display this peaceful smokey background for our ying yang:

<img src={useBaseUrl("https://images.unsplash.com/photo-1621193677201-096db5e45734?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80")} width="500"/>
...
<img src={useBaseUrl("/img/images/ios-bg-image.png")} alt="iOS bg image" width="50%" />
<img src={useBaseUrl("/img/images/android-bg-image.png")} alt="Android bg image" width="50%" />
